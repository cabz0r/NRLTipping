...
//echo $round_rowid . ',' . $map[array_search($i,$map, true) + 1] . ',' . $map[array_search($i+1,$map, true) + 1] . ',' . $round . ',' . $yearrowid . '</br>' ;

$dl->InsertTeamsByRound($round_rowid,$team1,$team2, $round, $yearrowid);
